...
PRODUCT_BUILD_PROP_OVERRIDES += \
    PRODUCT_NAME="surabaya" \
    PRIVATE_BUILD_DESC="surabaya-user 6.0.1 MXB48T 1 release-keys"

BUILD_FINGERPRINT := SMARTISAN/surabaya/surabaya:6.0.1/MXB48T/1:user/release-keys
